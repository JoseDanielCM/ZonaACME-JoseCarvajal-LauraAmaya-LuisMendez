            ...
            if (resultSet.next()) {
                ...
                switch (tipoUser){
                    case "SuperUsuario":
                        ...
                        return sesion;
                    case "Supervisor":
                        Supervisor supervisor = new Supervisor(id, nombre,contrasena,activo,empresa);
                        sesion = new Sesion(supervisor);
                        return sesion;
                    case "Guarda":
                        Guarda guarda = new Guarda(id, nombre,contrasena,activo,empresa);
                        sesion = new Sesion(guarda);
                        return sesion;
                    case "Funcionario":
                        Funcionario funcionario = new Funcionario(id, nombre,contrasena,activo,empresa);
